 ...
 *
 * Child override of the BeTheme search template to show updated dates
 * when a post has been modified after publication.
 *
													...
													<?php if ( mfn_opts_get( 'blog-meta' ) ) : ?>
														<div class="post-meta clearfix">
															<div class="author-date">
																...
																<span class="date"><span><?php echo esc_html( $translate['at'] ); ?> </span><i class="icon-clock"></i> <?php echo betheme_child_get_post_date_meta_html(); ?></span>
															</div>
														</div>
													<?php endif; ?>
