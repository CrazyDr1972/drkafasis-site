...
echo '<div class="close-wrapper">';
	echo '<a href="#" class="close" aria-label="Close"><i class="icon-cancel-fine"></i></a>';
echo '</div>';
...
echo '<div class="extras">';
	...
	echo '<div class="extras-wrapper">';
		...
		if ( $woocommerce && $show_cart ) {
			echo '<a class="icon cart" id="slide-cart" href="'. esc_url( wc_get_cart_url() ) .'"><i class="'. esc_attr($show_cart) .'"></i><span id="header-cart-count">'. esc_html( $woocommerce->cart->cart_contents_count ) .'</span></a>';
		}
