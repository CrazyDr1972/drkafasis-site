	...
	<footer id="Footer" class="clearfix <?php echo $footer_classes; ?>">
					...
					<div class="column one">
						...
						<?php
							if ($back_to_top_position == 'copyright') {
								echo '<a aria-label="Back to top" id="back_to_top" class="footer_button" href=""><i class="icon-up-open-big"></i></a>';
							}
						?>
		...
		<?php
			if ($back_to_top_position == 'footer') {
				echo '<a aria-label="Back to top" id="back_to_top" class="footer_button in_footer" href=""><i class="icon-up-open-big"></i></a>';
			}
		?>
...
<?php
	if ($back_to_top_position == 'body') {
		echo '<a aria-label="Back to top" id="back_to_top" class="footer_button '. esc_attr($back_to_top_class) .'" href=""><i class="icon-up-open-big"></i></a>';
	}
?>
