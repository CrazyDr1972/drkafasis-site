	...
	public function render( $meta = false )
	{
		...
		echo '<div class="form-group mfn-pills-field">';
			echo '<div class="form-control">';
				...
				echo '<input type="hidden" class="mfn-pills-input-hidden mfn-form-control mfn-form-input" value="'. esc_attr( $this->value ) .'" '. $this->get_name( $meta ) .' placeholder="'. esc_attr( $placeholder ) .'"/>';
